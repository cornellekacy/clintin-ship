...
<div class="container-fluid inner-offset">    
	<div class="row services">
		<div class="service-item col-xs-12 col-sm-4 wow zoomIn" data-wow-delay="0.3s">
			...
			<h4>SEA FREIGHT</h4>
			<p>ROYAL LOGISTICS Supply Chain Solutions offers a full array of global ocean freight and transportation services. We can handle almost any size shipment, from less-than-container loads to full container loads, special equipment, and oversized cargo. Our advanced tracking provides visibility of critical milestones throughout the journey..
