				...
				<div class="item">
					...
					<div class="container-fluid">
						<div class="slider-content col-md-6 col-lg-6">
							...
							<p>ROYAL LOGISTICS has a very large number of freight at it disposal and for this reason alone, we provide the best services. We are fast and reliable, secure and consistent<br><a class="btn btn-success" href="services.php">LEARN MORE</a></p>
						</div>
					</div>
				</div>
				<div class="item">
...
<div class="container">
	<div class="row">
					...
					<div class="col-md-8">
						<h3 align="center">WELCOME TO ROYAL LOGISTICS (USA).</h3>
			...
			<div class="container-fluid block-content">
				...
				<div class="row">
					<div class="col-sm-5 col-md-5 col-lg-5 welcome-text wow fadeInLeft" data-wow-delay="3.3s">
						<h1>About  ROYAL <strong>LOGISTICS</strong></h1>
						...
						<p>We are your best friend when it comes to package transportation and delivery, ROYAL LOGISTICS is the best company you can relly on if you buy online and you need a delivery service or if you are a business man and you need a reliable transport company to bring you goods to you. We also have warehouse services that can hold you goods untill you are ready to take.</p>
			...
			<div class="container-fluid">
				<div class="row column-info">
					...
					<div class="col-sm-4 col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
						...
						<span></span>
						<h3>AIR FREIGHT</h3>
						<p>Airfreight is fast-moving, challenging and constantly changing – it’s the nature of the business. Around the globe capacity and demand can change in the blink of an eye so it’s essential to have a partner who provides stability and reliability to maintain your supply chain’s total integrity. Whether your shipments fly in the bellies of commercial planes or require specialist freighter aircraft to move them, ROYAL LOGISTICS can provide tailor-made solutions for your all your airfreight.</p>
						<a class="btn btn-default btn-sm" href="services.php">READ MORE</a>
					</div>
					<div class="col-sm-4 col-md-4 col-lg-4 wow fadeInRight" data-wow-delay="0.3s">
						...
						<span></span>
						<h3>RAIL FREIGHT</h3>
						<p>Your company has a dilemma. You know that rail can provide a cost-effective way to ship your goods - but is it reliable? In today's business world, where any delay can spell disaster, ROYAL LOGISTICS Supply Chain Solutions can provide a dependable, cost-effective rail option
...
Non-perishable or general freight can also be handled with seamless efficiency. As one of the largest rail customers, we have the experience necessary to establish the service controls and schedules so vital to your business.</p>
				...
				<div class="row our-services styled">
					...
					<div class="col-sm-6 wow zoomInRight" data-wow-delay="0.3s">
						<a href="08_services-details.html">
							...
							<h4>HOME DELIVERY</h4>
							<p>ROYAL LOGISTICS also do home delivery for parcels and parkages. Make sure you give the right address when sending the parcel</p>
						</a>
					</div>
					<div class="col-sm-6 wow zoomInLeft" data-wow-delay="0.3s">
						<a href="08_services-details.html">
					...
					<div class="col-sm-6 wow zoomInRight" data-wow-delay="0.3s">
						<a href="08_services-details.html">
							...
							<h4>ROAD FREIGHT</h4>
							<p>Our buses are good and swift, transporting parkages has never been easier with ROYAL LOGISTICS. We are very reliable</p>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="big-hr color-2 wow zoomInUp" data-wow-delay="0.3s">
				<div class="text-left" style="margin-right:40px;">
					...
					<p>ROYAL LOGISTICS is fast, affordable, reliable and very safe. Trust us with you goods.</p>
				</div>
					...
					<div class="row">
						<div class="col-sm-6 col-md-6 col-lg-6 one-news wow fadeInLeft" data-wow-delay="0.3s">
							<div style="background-image:url(media/news-images/1.jpg);">
								<div>
									<a href="11_blog-details.html"><h3>ROYAL LOGISTICS has launch it new  cargo planes for the best services</h3></a>
