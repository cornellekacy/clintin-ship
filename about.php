<?php include 'header.php'; ?>
			...
			<div class="container-fluid inner-offset">
				<div class="hgroup text-center wow zoomIn" data-wow-delay="0.3s">
					...
					<h1>ROYAL LOGISTICS - THE RIGHT CHOICE</h1>
				</div>            
				...
				<div class="tab-content inner-offset wow fadeIn" data-wow-delay="0.3s">
					<div class="tab-pane active" id="tab1">
						<div class="row">
							...
							<div class="col-sm-7">
								<p><strong style="font-size:16px;">ROYAL LOGISTICS as you delivery company. we have all it takes to get your packages to you.</strong></p>
					...
					<div class="tab-pane" id="tab2">
						<div class="row">
							...
							<div class="col-sm-7 text-block">
								<p><strong>Our mission at ROYAL LOGISTICS is to provide our faithful clients with the best services we have been doing over the past years.</strong></p>
